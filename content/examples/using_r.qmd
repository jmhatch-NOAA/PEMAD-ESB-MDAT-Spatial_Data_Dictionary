...
<br>The rest of this tutorial will show you how to 1) find a feature layer url on the [MDAT GIS Data Hub](https://mdeb-nefsc-noaa.hub.arcgis.com/) and 2) read in the data from that feature layer.

## Find a feature layer url

Navigate to the [MDAT GIS Data Hub](https://mdeb-nefsc-noaa.hub.arcgis.com/).

```{r}
#| echo: false
#| out-width: 100%
knitr::include_graphics("image/mdeb_gis_data_hub.png")
```
...
#| echo: false
#| out-width: 100%
knitr::include_graphics("image/mdeb_gis_data_hub_ecomon_data.png")
```
...
#| echo: false
#| out-width: 100%
knitr::include_graphics("image/mdeb_gis_data_hub_ecomon_map.png")
```
...
#| echo: false
#| out-width: 100%
knitr::include_graphics("image/mdeb_gis_data_hub_ecomon_feature.png")
```
...
#| echo: true
#| eval: false
## Download EcoMon Survey strata from the MDAT GIS Data Hub
...
#| echo: false
#| out-width: 100%
knitr::include_graphics("image/ecomon_strata.png")
```
...
#| echo: false
#| out-width: 100%
knitr::include_graphics("image/ecomon_sne_strata.png")
```
