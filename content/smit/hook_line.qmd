...
hl_fields = purrr::map(.x = 1:nrow(hl_layers ), .f = function(.x) {
  ...
  hl_layer_meta = arcgisutils::fetch_layer_metadata(url = paste0(hl_url, '/', hl_layers$id[.x]))
  
  # layer description
  layer_desc =  hl_layer_meta$description
  layer_desc = gsub("\\n", '', layer_desc)  
