...
turtle_fields = purrr::map(.x = 1:nrow(turtle_layers), .f = function(.x) {
  ...
  turtle_layer_meta = arcgisutils::fetch_layer_metadata(url = paste0(turtle_url, '/', turtle_layers$id[.x]))
  
  # layer description
  layer_desc =  turtle_layer_meta$description
  layer_desc = gsub("\\n", '', layer_desc) 
